...
let exampleMoive1 = Movie(id: UUID().uuidString, name: "DARK", thumbnailURL: URL(string: "https://terrigen-cdn-dev.marvel.com/content/prod/1x/avengersendgame_lob_crd_05.jpg")!, cateogires: ["디스토피아", "암울", "긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 2, defaultEpisodeInfo: exampleEpisodeInfo1, creator: "김개똥", cast: "김아무개, 박아무개, 나아무개", moreLikeThisMovies: exampleMovies1, episode: [episode1, episode2], trailers: exampleTrailers )
let exampleMoive2 = Movie(id: UUID().uuidString, name: "Travelers", thumbnailURL: URL(string: "https://bigsonia.com/wp-content/uploads/IMDB_BigSoniaPoster27x40.jpeg")!, cateogires: ["디스토피아", "암울","긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 3 , defaultEpisodeInfo: exampleEpisodeInfo2, creator: "즌중징", cast: "홍아무개, 박아무개, 감감감", moreLikeThisMovies: exampleMovies2, episode: allEpisodes, promotionHeadline: "Watch Season 3 now", trailers: exampleTrailers)
...
let exampleMoive4 = Movie(id: UUID().uuidString, name: "Alone", thumbnailURL: URL(string: "https://images-na.ssl-images-amazon.com/images/I/71rNJQ2g-EL._AC_SL1178_.jpg")!, cateogires: ["디스토피아", "암울","긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 2, defaultEpisodeInfo: exampleEpisodeInfo4, creator: "강진진", cast: "나아무개, 홍길동, 느느느",moreLikeThisMovies: exampleMovies4, episode: allEpisodes, trailers: exampleTrailers  )
let exampleMoive5 = Movie(id: UUID().uuidString, name: "Hannibal", thumbnailURL: URL(string: "https://lh3.googleusercontent.com/proxy/z9_WpzZrhg3GzqneZ8dzfCEEc0F2SrPkUasa5SKRa3smxEDNoPaXp9Rlmcvm1qTy5Kwc360dcdt4hxU4qeO0oA_swgg5N2K6lw")!, cateogires: ["디스토피아", "암울","긴장감", "SF"],  year: 2020, rating: "TV-MA", numberOfSeasons: 3 , defaultEpisodeInfo: exampleEpisodeInfo5,creator: "홍길동", cast: "감아무개, 박아무개, 최아무개, 나아무개", moreLikeThisMovies: exampleMovies5, episode: allEpisodes, promotionHeadline: "new episode", trailers: exampleTrailers)
...
let episode9 = Episode(name: "Third Episode", episodeNumber: 9, season: 3, thumbnailImageURLString: randomExampleImageURLString, description: "jqioewjpfqowijefpoqwjepofjsdlkamvakdsjflkjqwepiojfpqioweurioqweupoirjqpwoiejflkadsm;lavmlkasjdfio;jqpewiojrioqwueoirqpejwifojlakdjfkl;ajdl;jfoiqwejroiquwepoiruqwoiejflkajdfkljadospfj qierupoqiweuroiqoiewjfpaㅇ아ㅓ레ㅐ뱌ㅓ델ㅈ더렙", length: 53, videoURL: exampleVideoURL)
