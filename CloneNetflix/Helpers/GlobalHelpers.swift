...
let exampleMoive1 = Movie(id: UUID().uuidString, name: "DARK", thumbnailURL: URL(string: "https://terrigen-cdn-dev.marvel.com/content/prod/1x/avengersendgame_lob_crd_05.jpg")!, cateogires: ["디스토피아", "암울", "긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 1,defaultEpisodeInfo: exampleEpisodeInfo1, creator: "김개똥", cast: "김아무개, 박아무개, 나아무개", moreLikeThisMovies: exampleMovies1 )
let exampleMoive2 = Movie(id: UUID().uuidString, name: "Travelers", thumbnailURL: URL(string: "https://bigsonia.com/wp-content/uploads/IMDB_BigSoniaPoster27x40.jpeg")!, cateogires: ["디스토피아", "암울","긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 3 , defaultEpisodeInfo: exampleEpisodeInfo2, creator: "즌중징", cast: "홍아무개, 박아무개, 감감감", moreLikeThisMovies: exampleMovies2, promotionHeadline: "Watch Season 3 now")
let exampleMoive3 = Movie(id: UUID().uuidString, name: "Community", thumbnailURL: URL(string: "https://d1csarkz8obe9u.cloudfront.net/posterpreviews/movie-poster-template-design-21a1c803fe4ff4b858de24f5c91ec57f_screen.jpg?ts=1574144362")!, cateogires: ["디스토피아", "암울","긴장감", "SF"],  year: 2020, rating: "TV-MA", numberOfSeasons: 5, defaultEpisodeInfo: exampleEpisodeInfo3, creator: "박뿌빠", cast: "김아무개, 신아무개, 전아무개", moreLikeThisMovies: exampleMovies3  )
let exampleMoive4 = Movie(id: UUID().uuidString, name: "Alone", thumbnailURL: URL(string: "https://images-na.ssl-images-amazon.com/images/I/71rNJQ2g-EL._AC_SL1178_.jpg")!, cateogires: ["디스토피아", "암울","긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 2, defaultEpisodeInfo: exampleEpisodeInfo4, creator: "강진진", cast: "나아무개, 홍길동, 느느느", moreLikeThisMovies: exampleMovies4  )
let exampleMoive5 = Movie(id: UUID().uuidString, name: "Hannibal", thumbnailURL: URL(string: "https://lh3.googleusercontent.com/proxy/z9_WpzZrhg3GzqneZ8dzfCEEc0F2SrPkUasa5SKRa3smxEDNoPaXp9Rlmcvm1qTy5Kwc360dcdt4hxU4qeO0oA_swgg5N2K6lw")!, cateogires: ["디스토피아", "암울","긴장감", "SF"],  year: 2020, rating: "TV-MA", numberOfSeasons: 3 , defaultEpisodeInfo: exampleEpisodeInfo5,creator: "홍길동", cast: "감아무개, 박아무개, 최아무개, 나아무개", moreLikeThisMovies: exampleMovies5, promotionHeadline: "new episode")
...
let exampleMoive7 = Movie(id: UUID().uuidString, name: "AfterLife", thumbnailURL: URL(string: "https://www.mauvais-genres.com/21970/logan-movie-poster-style-c-adv-29x41-in-2017-james-mangold-hugh-jackman.jpg")!, cateogires: ["디스토피아", "암울","긴장감", "SF"],  year: 2020, rating: "TV-MA" , numberOfSeasons: 2, defaultEpisodeInfo: exampleEpisodeInfo6, creator: "장빙봉", cast: "홍아무개, 최아무개, 이아무개, 나아무개, 박아무개", moreLikeThisMovies: exampleMovies7, promotionHeadline: "Watch Season6 now" )

let moreLikeThisMoive1 = Movie(id: UUID().uuidString, name: "DARK", thumbnailURL: URL(string: "https://terrigen-cdn-dev.marvel.com/content/prod/1x/avengersendgame_lob_crd_05.jpg")!, cateogires: ["디스토피아", "암울", "긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 1,defaultEpisodeInfo: exampleEpisodeInfo1, creator: "김개똥", cast: "김아무개, 박아무개, 나아무개" )
let moreLikeThisMoive2 = Movie(id: UUID().uuidString, name: "Travelers", thumbnailURL: URL(string: "https://bigsonia.com/wp-content/uploads/IMDB_BigSoniaPoster27x40.jpeg")!, cateogires: ["디스토피아", "암울","긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 3 , defaultEpisodeInfo: exampleEpisodeInfo2, creator: "즌중징", cast: "홍아무개, 박아무개, 감감감",  promotionHeadline: "Watch Season 3 now")
...
let moreLikeThisMoive4 = Movie(id: UUID().uuidString, name: "Alone", thumbnailURL: URL(string: "https://images-na.ssl-images-amazon.com/images/I/71rNJQ2g-EL._AC_SL1178_.jpg")!, cateogires: ["디스토피아", "암울","긴장감", "SF"], year: 2020, rating: "TV-MA", numberOfSeasons: 2, defaultEpisodeInfo: exampleEpisodeInfo4, creator: "강진진", cast: "나아무개, 홍길동, 느느느"  )
